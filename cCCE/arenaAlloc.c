...
/*
    Frees all memory assocated with an arenaManager and then frees the
    arenaManager itself.
...
/*
    ...
    allocated memory.  In certan use cases, this can provide a significant 
...
/* 
   Uncomment main() below to test arenaManager
*/
/*
