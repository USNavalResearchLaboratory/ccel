...
/*
    Given an linked-list containing a layer of a CCE tree, calculate 
    what percentage of patterns are unique at this layer of the tree.
    Input Args:
        llRoot* r: 
...
/*
    ...
    percentage of patterns are unique at this layer of the tree.
    Input Args:
        llRoot* r: 
