...
/*
    ...
    Returns:
        llRoot*: the pointer to the created root.
*/
...
/*
    Creates a node of the linked list. A node contains a void* to some
...
/*
    Inserts node at the back of a list.
...
/*
    Inserts node at the front of a list.
...
/*
    ...
    the linked list. If the pointer to the user defined function is
